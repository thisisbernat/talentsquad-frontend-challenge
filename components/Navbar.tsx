...
const Navbar = () => {
  ...
  return (
    <>
      <div className="bg-gradient-to-t from-zinc-800 to-zinc-900 px-5 pt-3 pb-10 text-white flex flex-col md:flex-row items-center justify-between">
        <Link href="/">
        ...
        <div className="text-white h-6 w-6 md:hidden"><Bars3Icon /></div>
        <div className="flex flex-col md:flex-row md:items-center gap-7 text-sm font-semibold pt-1">
          <Link href="/">
